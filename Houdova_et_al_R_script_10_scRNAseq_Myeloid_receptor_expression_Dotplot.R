...
signatures <- list(Mono = Mono, Macrophage = Macrophage, Microglia = Microglia) # Add more signatures as needed

seurat_obj <- obj_Abdelfattah_Myeloid
...
custom_cellstate_order <- c("Microglia", "M1", "M2", "Mono", "None")

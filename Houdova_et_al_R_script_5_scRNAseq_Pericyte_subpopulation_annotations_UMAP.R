# -----------------------------------------------------------------------------------------
#                               Pericyte sub-population annotations
# -----------------------------------------------------------------------------------------
...
Interferon_PCs <- c("CSF2RA", "SAMSN1", "CD53", "DOCK2", "ADAM28", "PTPRC", "SLA", "RBM47", "HLA-DRB1", "VSIG4", "RNF144B", "ITGB2", "PLEK", "SLC11A1", "FYB", "HLA-DQB1", "CD86", "MSR1", "ITGAX", "SLC16A10", "MS4A4A", "SYK", "NLRP3", "FCGR3A", "AOAH", "FCER1G", "C1QC", "LCP1")
SMCs <- c("MYH11", "CSDC2", "DES", "AC097724.3", "PLN", "LMOD1", "CNN1", "NET1", "MYOCD")
FAP_PCs <- c("POSTN", "CA12", "CXCL6", "FBLN2", "CYP1B1", "FAP", "COL11A1", "PDGFRA", "SFRP2", "FLRT2", "THBS2", "SGCD", "FMOD", "LTBP2", "CLDN11", "GAS7", "PDPN", "ELN", "OGN", "CLMP", "BICC1", "ROR2", "SFRP4", "GJA1", "OMD")

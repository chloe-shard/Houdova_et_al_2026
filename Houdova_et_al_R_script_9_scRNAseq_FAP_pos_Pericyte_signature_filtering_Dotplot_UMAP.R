...
# Mark genes to DROP if ANY off-target cell type has frac_bad >= threshold
...
# Enforce "gene must have at least X datasets overall"
...
# Final filtered gene list (KEPT genes)
...
# Inspect drop reasons (fraction-based)
...
#### Add signature to Seurat objects to plot on UMAPs ####
